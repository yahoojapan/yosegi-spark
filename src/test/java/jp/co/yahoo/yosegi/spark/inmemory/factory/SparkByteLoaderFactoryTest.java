...
import jp.co.yahoo.yosegi.spark.inmemory.loader.SparkUnionByteLoader;
...
class SparkByteLoaderFactoryTest {
  ...
  void T_createLoader_Sequential(final String binaryMakerClassName) throws IOException {
    ...
    final ILoader loader = new SparkByteLoaderFactory(vector).createLoader(columnBinary, loadSize);

    assertTrue(loader instanceof SparkSequentialByteLoader);
  }
  ...
  void T_createLoader_Dictionary(final String binaryMakerClassName) throws IOException {
    ...
    assertTrue(loader instanceof SparkDictionaryByteLoader);
  }
  ...
  void T_createLoader_Const(final String binaryMakerClassName) throws IOException {
    ...
    assertTrue(loader instanceof SparkConstByteLoader);
  }
  ...
  void T_createLoader_Union(final String binaryMakerClassName) throws IOException {
    ...
    assertTrue(loader instanceof SparkUnionByteLoader);
  }
