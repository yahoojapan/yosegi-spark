...
import jp.co.yahoo.yosegi.spark.inmemory.loader.SparkUnionIntegerLoader;
...
class SparkIntegerLoaderFactoryTest {
  ...
  void T_createLoader_Sequential(final String binaryMakerClassName) throws IOException {
    ...
    final ILoader loader =
        new SparkIntegerLoaderFactory(vector).createLoader(columnBinary, loadSize);

    assertTrue(loader instanceof SparkSequentialIntegerLoader);
  }
  ...
  void T_createLoader_Dictionary(final String binaryMakerClassName) throws IOException {
    ...
    assertTrue(loader instanceof SparkDictionaryIntegerLoader);
  }
  ...
  void T_createLoader_Const(final String binaryMakerClassName) throws IOException {
    ...
    assertTrue(loader instanceof SparkConstIntegerLoader);
  }
  ...
  void T_createLoader_Union(final String binaryMakerClassName) throws IOException {
    ...
    assertTrue(loader instanceof SparkUnionIntegerLoader);
  }
