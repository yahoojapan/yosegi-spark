...
import jp.co.yahoo.yosegi.spark.inmemory.loader.SparkUnionShortLoader;
...
class SparkShortLoaderFactoryTest {
  ...
  void T_createLoader_Sequential(final String binaryMakerClassName) throws IOException {
    ...
    final ILoader loader = new SparkShortLoaderFactory(vector).createLoader(columnBinary, loadSize);

    assertTrue(loader instanceof SparkSequentialShortLoader);
  }
  ...
  void T_createLoader_Dictionary(final String binaryMakerClassName) throws IOException {
    ...
    assertTrue(loader instanceof SparkDictionaryShortLoader);
  }
  ...
  void T_createLoader_Const(final String binaryMakerClassName) throws IOException {
    ...
    assertTrue(loader instanceof SparkConstShortLoader);
  }
  ...
  void T_createLoader_Union(final String binaryMakerClassName) throws IOException {
    ...
    assertTrue(loader instanceof SparkUnionShortLoader);
  }
