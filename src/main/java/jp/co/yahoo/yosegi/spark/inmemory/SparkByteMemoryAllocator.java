...
public class SparkByteMemoryAllocator implements IMemoryAllocator{

  private final WritableColumnVector vector;
  private final int vectorSize;

  public SparkByteMemoryAllocator( final WritableColumnVector vector , final int vectorSize ){
    this.vector = vector;
